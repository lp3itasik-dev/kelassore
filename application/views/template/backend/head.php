<meta charset="utf-8">
  ...
  <!-- Favicons -->
  <link href="<?php echo base_url(); ?>assets/frontend/img/lp3i-head.png" rel="icon">
  <link href="<?php echo base_url(); ?>assets/frontend/img/lp3i-head.png" rel="apple-touch-icon">
